        ...
        <form class="mt-3" action="{{ route('topic.store') }}" method="post">
            ...
            <div class="row">
                <div class="form-group col-12">
                    <input name="title" id="title" class="form-control" placeholder="Заголовок">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        <textarea name="content" id="content" cols="150" rows="10" placeholder="Содержание топика" class="form-control"></textarea>
                    </div>
                </div>
            </div>
            <div class="row">
